...
=====================
晶世科保 · Vibe Marketing
v0.8 — 基于平安/中再/Munich Re/Allianz行业标准校准 + 自学习引擎
"""
...
with tab3:
    ...
    st.markdown("""
    **版本: v0.8 — 16维评分卡（基于平安/中再/Munich Re/Allianz行业标准）**
    ...
    **费率校准基准**:
    ...
    | 🔴 高风险 | 10.0% - 14.0% | 运载投送·特殊任务 |
    | ⚠️ 极高风险 | 14.0% - 18.0% | 建议转再保 |
...
st.markdown("---")
st.markdown("*晶世科保 · 无人机保险AI引擎 v0.8 · 16维评分卡 · 参考平安/中再/Munich Re/Allianz行业标准 · 🔄 自学习引擎*")
